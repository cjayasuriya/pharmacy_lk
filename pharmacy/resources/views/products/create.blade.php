            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/products/create/save" method="POST">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="uom" type="text" class="form-control @error('uom') is-invalid @enderror" name="uom" value="{{ old('uom') }}" required autocomplete="uom">
                                    @error('uom')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="selling_price" type="number" step="any" class="form-control @error('selling_price') is-invalid @enderror" name="selling_price" value="{{ old('selling_price') }}" required autocomplete="selling_price">
                                    @error('selling_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="lowest_price" type="text" class="form-control @error('lowest_price') is-invalid @enderror" name="lowest_price" value="{{ old('lowest_price') }}" required autocomplete="lowest_price">
                                    @error('lowest_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                <div class="container-fluid">
                                    <input type="submit" class="btn btn-outline-primary btn-block" id="add-product-btn" name="add-product-btn" value="Save"/>
                                    <br>
                                </div>
                            </div>
